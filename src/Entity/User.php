...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @Groups({"users_get_item", "users_get_collection", "candidates_get_item", "jobs_get_item" })
     */
    private $id;
     ...
     * )
     * @Groups({"users_get_item", "users_get_collection", "recruiters_get_collection", "recruiters_get_item", "candidates_get_item", "jobs_get_item"})})
     */
    private $email;
